...
public class ListViewCPUAdater extends BaseAdapter {
    ...
    // 생성자
    public ListViewCPUAdater(Context context, ArrayList<ObjectCPU> ListView) {
        m_List = ListView;
        mContext = context;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.view_cpu_obj, null);
